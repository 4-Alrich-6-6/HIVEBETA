            ...
            <div class="mp-modal" role="dialog" aria-modal="true" aria-labelledby="mpTitle">
                ...
                <div class="mp-body">
                    ...
                    <div class="mp-field">
                        ...
                        <input type="text" id="mpDisplayName" maxlength="30" placeholder="Enter your Display Name">
                    </div>
                    <div class="mp-field">
    ...
    const init = async () => {
        ...
        saveBtn.addEventListener("click", () => {
            ...
            if (displayName.length > 30) {
                showAlert("Display name must be 30 characters or fewer.", { title: "Name Too Long" });
                return;
            }
            if (!fieldId) {
